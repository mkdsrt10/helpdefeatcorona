...
const List = ({vitals, personal, symptoms, onRouteChange, route}) => {
	...
	let z = (
		<div className="tl b--light-gray bg-white ba Avenir pb3" style={{"font-family":"Avenir", flex: 1}}>
			...
			<div className="mt2 pt3 pb0 w-75">
				<p onClick={()=>onRouteChange("personal")} className="ml4 mt3 mb1 pointer dark-gray" style={{"font-size":(isMobile)?"18px":"24px",  "font-weight": (route === "personal") ? "bold" : "normal", color: (route==="personal") ? "rgb(255, 127, 129)" : "black"}}>PERSONAL</p>
			...
			<div className="w-80">
				<p onClick={()=>onRouteChange("vitals")} className="ml4 mt0 pointer mb1 dark-gray" style={{"font-size":(isMobile)?"18px":"24px", "font-weight": (route === "vitals") ? "bold" : "normal", color: (route==="vitals") ? "rgb(255, 127, 129)" : "black"}}>DAILY VITALS</p>
